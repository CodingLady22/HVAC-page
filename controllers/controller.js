...
// Controller for requesting a schedule
...
exports.quoteService = async(req, res) => {
    ...
    let quoteEmailText = `Dear ${name}, 
        ...
        One of our knowledgeable reps will email you at this address within one business day to hear more about how we can assist you. For your records, your message to us is below:
